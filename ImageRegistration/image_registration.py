...
source_path = os.path.join(base_dir,"cd-uav/before/DJI_20220506101539_0085_Z.JPG")
target_path = os.path.join(base_dir,"cd-uav/after/DJI_20220506105215_0086_Z.JPG")
# base_dir = os.path.dirname(os.path.abspath(__file__))
# source_path = os.path.join(base_dir,"Images/mona_source.png")
# target_path = os.path.join(base_dir,"Images/mona_target.jpg")
